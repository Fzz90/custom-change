...
(function () {
  ...
  var fullscreenOptionName =
    String(parameters["fullscreenOptionName"]) || "Fullscreen";
  var forceFullscreen = String(parameters["forceFullscreen"]);
  var fullscreenOptionCommand =
    String(parameters["Add command to option?"]) === "true" ? true : false;
  ...
  /* Alias */
  var _Window_Options_addGeneralOptions_Alias =
