...
MUSH_Achievements.prototype.createSceneDetails = function () {
  ...
  //   - One line Max.
  //-----------------------------------------------
  this._snDetails.sceneDescription = "Press" + "\\c[" + 31 + "]" + " space " + "\\c[" + 0 + "]" + "button to toggle the scene view!";
  //-----------------------------------------------
...
MUSH_Achievements.prototype.createAchievementsList = function () {
  var achList = [
    ...
    [
      ...
      6851,
      "", //  ! image file
      "Kill 25 Enemies with" + "\\i[" + 1088 + "]" +  "Physical Elemental Skills or Items",
      "3/0/500",
      "2/66/25",
      false,
      false,
    ...
    [
      ...
      6852,
      "", //  ! image file
      "Kill 50 Enemies with" + "\\i[" + 1088 + "]" +  "Physical Elemental Skills or Items",
      "3/0/1000",
      "2/66/50",
      false,
      false,
    ...
    [
      ...
      6853,
      "", //  ! image file
      "Kill 100 Enemies with" + "\\i[" + 1088 + "]" +  "Physical Elemental Skills or Items",
      "4/0/1250",
      "2/66/100",
      false,
      false,
    ...
    [
      ...
      6854,
      "", //  ! image file
      "Kill 200 Enemies with" + "\\i[" + 1088 + "]" +  "Physical Elemental Skills or Items",
      "4/0/2500",
      "2/66/200",
      false,
      false,
    ...
    [
      ...
      6855,
      "", //  ! image file
      "Kill 500 Enemies with" + "\\i[" + 1088 + "]" +  "Physical Elemental Skills or Items",
      "4/0/5000",
      "2/66/500",
      false,
      false,
    ...
    [
      ...
      6856,
      "", //  ! image file
      "Kill 1000 Enemies with" + "\\i[" + 1088 + "]" +  "Physical Elemental Skills or Items",
      "5/0/30",
      "2/66/1000",
      false,
      false,
    ...
    [
      ...
      6857,
      "", //  ! image file
      "Kill 1500 Enemies with" + "\\i[" + 1088 + "]" +  "Physical Elemental Skills or Items",
      "5/0/65",
      "2/66/1500",
      false,
      false,
    ...
    [
      ...
      6858,
      "", //  ! image file
      "Kill 2500 Enemies with" + "\\i[" + 1088 + "]" +  "Physical Elemental Skills or Items",
      "5/0/100",
      "2/66/2500",
      false,
      false,
    ...
    [
      ...
      6859,
      "", //  ! image file
      "Kill 4500 Enemies with" + "\\i[" + 1088 + "]" +  "Physical Elemental Skills or Items",
      "5/0/150",
      "2/66/4500",
      false,
      false,
    ...
    [
      ...
      6860,
      "", //  ! image file
      "Kill 7000 Enemies with" + "\\i[" + 1088 + "]" +  "Physical Elemental Skills or Items",
      "5/0/225",
      "2/66/7000",
      false,
      false,
